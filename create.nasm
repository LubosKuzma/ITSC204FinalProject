...
_start:
    _file:                              ;file function
        ...
        .create:
            ...
            syscall
            mov r8, rax                 ;save file descriptor in r8     (There is a problem, if I save it in r9, the file will be a binary file)
        ...
        .write.nosort:
            ...
            mov rbx, r8                 ;our file descriptor
            mov rax, 0x1                ;write syscall
            syscall
